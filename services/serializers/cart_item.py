...
#     class Meta:
#         model = CartItem
#         fields = ["id", "item_type", "plate_variant", "quantity", "drilling_service", "holes_count", "unite_price", "total_price", "created_at", "updated_at"]
#         read_only_fields = ["id", "unite_price", "total_price", "created_at", "updated_at"]
